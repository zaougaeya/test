...
import { getUsers, getUserById, updateUser, deleteUser, register, login, forgotPassword, resetPassword,verifyToken } from '../Controllers/UserController.js';
...
router.post('/reset-password', [
    body('token').isLength({ min: 6 }).withMessage('token'),
    body('passworduser').isLength({ min: 6 }).withMessage('pwds')
], resetPassword);
